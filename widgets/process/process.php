                        ...
                        <div class="designer-process-item-inner">
                            <div class="designer-process-content">
                                ...
                                <?php
                                    ...
                                    $allowed_layouts = ['horizontal', 'vertical'];

                                    // Validate layout input
                                    $layout = isset($settings['layout']) ? sanitize_text_field($settings['layout']) : 'horizontal';

                                    if (in_array($layout, $allowed_layouts)) {
                                        $file_path = \Designer::plugin_dir() . 'widgets/process/snippets/layout-' . $layout . '.php';
