...
<div class="block--posts-grid">
    <div class="grid <?php echo esc_attr( $settings['layout'] ); ?>">
        ...
        while ( $query->have_posts() ) : $query->the_post();
            ...
            <div class="grid__item <?php echo esc_attr( implode(' ', $classes) ); ?> post-item <?php echo esc_attr( $settings['card_layout'] ); ?>">
                <article id="post-<?php the_ID(); ?>" <?php post_class('post-grid-list'); ?>>
                    <div class="content">
                        ...
                        <?php } ?>
                        <div class="post-content content-bottom text-<?php echo esc_attr( $settings['alignment'] ); ?>">
                            <?php
