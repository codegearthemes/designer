;( function ( $ , window , document , undefined ) {
	...
	$.extend( Lightboxed.prototype , {
		...
		init : function () {
			...
			this.lightbox.close = ( this.lightbox.container.find( '#' + namespace + 'bttn_close' ).length > 0 ) ? this.lightbox.container.find( '#' + namespace + 'bttn_close' ) : jQuery( '<div id="' + namespace + 'bttn_close"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M35 35L1 1L35 35Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M35 1L1 35" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></svg>' ).appendTo( this.lightbox.container );
			this.lightbox.prev = ( this.lightbox.container.find( '#' + namespace + 'bttn_prev' ).length > 0 ) ? this.lightbox.container.find( '#' + namespace + 'bttn_prev' ) : jQuery( '<div id="' + namespace + 'bttn_prev"><svg xmlns="http://www.w3.org/2000/svg" width="31" height="72" viewBox="0 0 31 72" fill="none"><path d="M30 1L1 36.5L30 71" stroke="currentColor"/></svg></div>' ).appendTo( this.lightbox.container );
			this.lightbox.next = ( this.lightbox.container.find( '#' + namespace + 'bttn_next' ).length > 0 ) ? this.lightbox.container.find( '#' + namespace + 'bttn_next' ) : jQuery( '<div id="' + namespace + 'bttn_next"><svg xmlns="http://www.w3.org/2000/svg" width="31" height="72" viewBox="0 0 31 72" fill="none"><path d="M1 1L30 36.5L1 71" stroke="currentColor"/></svg></div>' ).appendTo( this.lightbox.container );
